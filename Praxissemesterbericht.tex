...
%TODO am Ende nochmal überarbeiten
...
--> Definition OSA
%TODO Den Schwachsinn korrigieren
...
\subsubsection{prisma Smart} %TODO Text ausbauen!
...
\begin{description}
	...
	\label{risikomatrix}
	\end{figure}
%TODO ist der Text fachlich/gut formuliert?
...
\begin{description}
	\item[Verifizierung] Code == Lastenheft / Funktionsfähig %TODO noch ergänzen!
	
	\item[Validierung] Code == Nutzungsziele erfüllt? %TODO noch ergänzen!
...
\newpage
\section{Diskussion}
%Interpretation: Die Bedeutung der Ergebnisse erläutern. Was sagen sie aus, und wie passen %sie zu den Zielen des Praxissemesters?
%Reflexion: Schwierigkeiten und Herausforderungen analysieren.
%Verbindungen: Relevanz der Arbeit für die Praxis oder theoretische Grundlagen darlegen.
%Ausblick: Verbesserungsvorschläge und potenzielle nächste Schritte aufzeigen.
%TODO noch ergänzen!

\newpage
\section{Fazit}
%Reflektion über den Lernerfolg, Herausforderungen, erreichte Ziele, und potenzielle %Verbesserungen.
%TODO noch ergänzen!
